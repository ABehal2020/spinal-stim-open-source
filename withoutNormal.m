...
% position matrix initially filled with zeros
pos = zeros(1204,1000); % i defined a matrix for the muscle positions

% Muscle Positions y-x
%front mid:247
% reading values from excel spreadsheet to proper body positions
...
kernel = fspecial('average', [100 100]);
% replicate option turns input array values outside the bounds of the array
% into values at the nearest border
density = imfilter(pos, kernel, 'replicate');
